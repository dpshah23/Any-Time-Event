    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expires_at', models.DateTimeField(default=datetime.datetime(2024, 7, 4, 2, 31, 51, 93373, tzinfo=datetime.timezone.utc))),
            ],
        ),
        migrations.CreateModel(
            name='resetpass',
            fields=[
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('expires_at', models.DateTimeField(default=datetime.datetime(2024, 7, 4, 3, 26, 51, 93373, tzinfo=datetime.timezone.utc))),
            ],
        ),
        migrations.CreateModel(
            name='users',
